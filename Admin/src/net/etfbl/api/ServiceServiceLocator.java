...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements net.etfbl.api.ServiceService {
    ...
    private java.lang.String Service_address = "http://localhost:8080/SOAP/services/Service";
    ...
    public net.etfbl.api.Service getService() throws javax.xml.rpc.ServiceException {
    ...
    public net.etfbl.api.Service getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            net.etfbl.api.ServiceSoapBindingStub _stub = new net.etfbl.api.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (net.etfbl.api.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                net.etfbl.api.ServiceSoapBindingStub _stub = new net.etfbl.api.ServiceSoapBindingStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://api.etfbl.net", "ServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://api.etfbl.net", "Service"));
        }
